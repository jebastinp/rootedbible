...
def list_all_families(db: Session = Depends(get_db), _: User = Depends(require_super_admin)):
...
def list_all_buddy_groups(db: Session = Depends(get_db), _: User = Depends(require_super_admin)):
...
def list_all_churches(db: Session = Depends(get_db), _: User = Depends(require_super_admin)):
...
def list_all_fellowships(db: Session = Depends(get_db), _: User = Depends(require_super_admin)):
...
def update_church(church_id: uuid.UUID, payload: ChurchUpdate, current_user: User = Depends(require_super_admin), db: Session = Depends(get_db)):
...
def deactivate_church(church_id: uuid.UUID, current_user: User = Depends(require_super_admin), db: Session = Depends(get_db)):
    svc = CommunityService(db)
...
def activate_church(church_id: uuid.UUID, current_user: User = Depends(require_super_admin), db: Session = Depends(get_db)):
    svc = CommunityService(db)
...
def delete_church(church_id: uuid.UUID, current_user: User = Depends(require_super_admin), db: Session = Depends(get_db)):
...
def update_fellowship(fellowship_id: uuid.UUID, payload: FellowshipUpdate, current_user: User = Depends(require_super_admin), db: Session = Depends(get_db)):
    svc = CommunityService(db)
...
def deactivate_fellowship(fellowship_id: uuid.UUID, current_user: User = Depends(require_super_admin), db: Session = Depends(get_db)):
    svc = CommunityService(db)
...
def activate_fellowship(fellowship_id: uuid.UUID, current_user: User = Depends(require_super_admin), db: Session = Depends(get_db)):
    svc = CommunityService(db)
...
def delete_fellowship(fellowship_id: uuid.UUID, current_user: User = Depends(require_super_admin), db: Session = Depends(get_db)):
